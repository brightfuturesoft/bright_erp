...
const AddModule = ({ openModal, setOpenModal }) => {
    ...
    const Tooltip = ({ text }) =>
        _jsx('div', {
            className:
                'absolute bg-gray-700 text-white text-xs rounded px-2 py-1 z-10',
            children: text,
        });
                ...
                children: _jsx('div', {
                    ...
                    children: _jsxs('main', {
                        ...
                        children: [
                            _jsxs('div', {
                                className:
                                    'flex items-center justify-between pb-6 dark:border-b-gray-500 border-gray-600 border-b mb-6',
                                children: [
                                    _jsx('h1', {
                                        className:
                                            'text-2xl dark:text-white text-dark',
                                        children: 'Add New Plan',
                                    }),
                                    _jsx('button', {
                                        onClick: () => setOpenModal(false),
                                        className:
                                            'flex dark:bg-light-dark dark:text-white bg-slate-950 text-white px-3 py-2 rounded-lg',
                                        children: 'Close',
                                    }),
                                ],
                            }),
                            _jsxs('div', {
                                className:
                                    'md:grid gap-2 lg:grid-cols-3 rounded-lg',
                                children: [
                                    _jsx('div', {
                                        className:
                                            'space-y-8 h-screen  custom-scroll px-3 col-span-2 lg:mb-6',
                                        children: _jsx('div', {
                                            className:
                                                'rounded-lg border dark:text-light text-black dark:bg-light-dark bg-[white] text-card-foreground shadow-sm',
                                            children: _jsx('div', {
                                                        ...
                                                        _jsxs('div', {
                                                            ...
                                                            children: [
                                                                ...
                                                                _jsx('input', {
                                                                    ...
                                                                    className:
                                                                        'bg-transparent flex h-10 w-full rounded-md border px-3',
                                                                    placeholder:
                                                                                    ...
                                                                                    [
                                                                                        _jsxs(
                                                                                            'div',
                                                                                            {
                                                                                                ...
                                                                                                className:
                                                                                                    'flex gap-2 justify-between relative',
                                                                                                children:
                                                                                                    [
                                                                                                        _jsxs(
                                                                                                            'div',
                                                                                                                ...
                                                                                                                children:
                                                                                                                    [
                                                                                                                        _jsx(
                                                                                                                            ...
                                                                                                                            {
                                                                                                                                className:
                                                                                                                                    'w-14 h-14 rounded border bg-cover object-cover',
                                                                                                                                style: {
                                                                                                                    ...
                                                                                                                    [
                                                                                                                        ...
                                                                                                                        _jsx(
                                                                                                                            'button',
                                                                                                                            {
                                                                                                                                ...
                                                                                                                                title: 'Details',
                                                                                                                                className:
                                                                                                                                    'text-2xl duration-200 hover:text-success text-gray-400 dark:text-gray-600',
                                                                                                                                children:
                                                                                                                                    _jsx(
                                                                                                                                        DownCircleOutlined,
                                                                                                                                        {
                                                                                                                                            className:
                                                                                                                                                'hover:text-info duration-200',
                                                                                                                                        }
                                                                                                                                    ),
                                                                                                                            }
                                                                                                                        ),
                                    ...
                                    _jsx('div', {
                                        className: 'space-y-8 lg:mb-0 md:mb-6',
                                        children: _jsxs('div', {
                                            className:
                                                'rounded-lg border dark:text-light text-black dark:bg-light-dark bg-[white] text-card-foreground shadow-sm',
                                            children: [
                                                _jsx('div', {
                                                    className:
                                                        'flex flex-col space-y-1.5 lg:p-6 p-2',
                                                    children: _jsx('h3', {
                                                        className:
                                                ...
                                                _jsx('div', {
                                                    ...
                                                    children: _jsxs('div', {
                                                        ...
                                                        children: [
                                                                                            ...
                                                                                            [
                                                                                                ...
                                                                                                _jsx(
                                                                                                    Button,
                                                                                                    {
                                                                                                        ...
                                                                                                        ghost: true,
                                                                                                        className:
                                                                                                            'bg-[#ff003741] text-[rgb(255,111,111)]  ',
                                                                                                        icon: _jsx(
                                                                                                            DeleteOutlined,
                                                                                                            {}
                                                                                                        ),
                                                            ...
                                                            _jsxs('div', {
                                                                className:
                                                                    'border-t border-gray-200 mt-4 pt-4 flex justify-between font-semibold',
                                                                children: [
                                                                    _jsx(
                                                                        'span',
                                                                        {
                                                ...
                                                _jsx('div', {
                                                    className:
                                                        'flex items-center lg:p-6 p-2',
                                                    children: _jsx(Link, {
                                                        to: `/payment`,
                                                        className:
                                                            'inline-flex items-center bg-slate-950 text-white justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-10 px-4 py-2 w-full',
                                                        children:
                                                            'Complete Purchase',
                                                    }),
                                                }),
