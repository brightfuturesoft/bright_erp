...
const Modules = () => {
    ...
    return _jsxs('section', {
        className:
            'py-10 bg-gray-50 dark:bg-dark dark:text-light text-black sm:py-16 lg:py-24',
        children: [
            _jsx(Title, { subtitle: 'Our Modules', title: 'Modules' }),
            _jsx('div', {
                className: 'px-4 mt-16 mx-auto max-w-7xl sm:px-6 lg:px-8',
                children: _jsx('div', {
                    className:
                        'grid grid-cols-1 gap-12 text-center sm:grid-cols-2 md:grid-cols-3 lg:gap-y-16',
