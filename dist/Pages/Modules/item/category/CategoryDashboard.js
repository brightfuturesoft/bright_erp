...
export default function CategoryDashboard() {
    ...
    const [addParentCategory, setAddParentCategory] = useState(null);
    ...
    const handleEditSave = async values => {
        ...
        if (imageList.length) {
            const f = imageList[0];
            if (f.originFileObj) imageUrl = await uploadImage(f.originFileObj);
    ...
    // Export / Import
    const handleExport = allOrSelected => {
        const dataToExport =
            allOrSelected === 'all'
                ? categories
    ...
    return _jsxs(ConfigProvider, {
        children: [
            ...
            _jsxs('div', {
                ...
                children: [
                    _jsx(Category_stats_cards, { stats: stats }),
                    _jsx(Category_filters, {
                    ...
                    _jsx('div', {
                        className:
                            'rounded-t border dark:bg-gray-900 dark:text-gray-100 dark:border-gray-700',
                        children:
                            currentView === 'tree'
                                ? _jsx(Category_tree_view, {
