...
const AttributeSet = () => {
    ...
    // Make inactive
    const handleMakeInactive = async attribute => {
        const response = await fetch(
    ...
    // Make active
    const handleMakeActive = async attribute => {
        const response = await fetch(
            `${import.meta.env.VITE_BASE_URL}items/attribute/update-attribute`,
            {
                method: 'PUT',
    ...
    // Remove discount
    const handleRemoveDiscount = async attribute => {
        const response = await fetch(
            `${import.meta.env.VITE_BASE_URL}items/attribute/update-attribute`,
            {
                method: 'PUT',
