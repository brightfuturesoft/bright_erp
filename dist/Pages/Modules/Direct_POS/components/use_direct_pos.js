...
const use_direct_pos = () => {
    ...
    const [current_order_data, set_current_order_data] = useState(null);
    ...
    const selected_customer = useMemo(() => {
        return (
    ...
    const handle_customer_change = useCallback(
        customer_id => set_selected_customer_id(customer_id),
        []
    );
            ...
            const matches_category =
                selected_category === 'All Categories'
                    ...
                    : product.category?.some(
                          category => category.label === selected_category
                      );
    ...
    const safe_fixed = (num, digits = 2) => (num ?? 0).toFixed(digits);
