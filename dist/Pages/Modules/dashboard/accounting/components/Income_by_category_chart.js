...
const Income_by_categoryChart = () => {
    let chartInstance1 = null;
    let chartInstance2 = null;
    let chartInstance3 = null; // Add a reference for the third chart
    useEffect(() => {
        // Create a new chart instance for the first chart (Income Categories)
        const ctx1 = document.getElementById('pie-chart-1');
        if (ctx1) {
        ...
        const ctx2 = document.getElementById('pie-chart-2');
        if (ctx2) {
        ...
        const ctx3 = document.getElementById('pie-chart-3');
        if (ctx3) {
    ...
    return _jsxs('div', {
        className:
            'gap-6 border-gray-200 dark:border-gray-700 grid md:grid-cols-2 mt-10 pt-4 border-t',
        children: [
            _jsxs('div', {
                className:
                    'flex flex-col bg-[#fff] dark:bg-light-dark dark:ring-0 items-center shadow-xl dark:shadow-none rounded overflow-hidden ring-1 ring-gray-300',
                children: [
                    _jsx('header', {
                        className:
                            'flex items-center bg-gray-700 px-3 w-full h-[50px] capitalize',
