...
export default function ThemeCustomizer() {
    ...
    return _jsxs('div', {
        className: 'min-h-screen dark:bg-gray-900 bg-gray-50 p-4 md:p-8',
        children: [
            _jsx('h1', {
                className:
                    'text-3xl font-bold dark:text-white text-gray-900 mb-8',
            ...
            _jsx('button', {
                ...
                className:
                    'px-6 py-3 bg-blue-600 text-white rounded-lg font-medium mb-6',
                children: 'Save Theme',
            }),
            _jsxs('div', {
                className:
                    'flex flex-col items-center p-6 space-y-4 min-h-screen',
                children: [
                    _jsx(PreviewModeSwitcher, { mode: mode, setMode: setMode }),
                    _jsx(PreviewIframe, {
                        refProp: iframeRef,
                        mode: mode,
                        sizes: sizes,
