...
const checkingpath = [{ name: 'Staff' }, { name: 'Product' }];
...
const nav = [
    ...
    },
    {
        ...
        path: 'accounting',
        isDropdown: true,
        icon: _jsx(BadgeDollarSign, { size: 20 }),
        children: [
            {
                id: '1.1',
    ...
    },
    {
        ...
        path: 'hr-module',
        isDropdown: true,
        icon: _jsx(CircleUserRound, { size: 20 }),
        children: [
            {
                id: '8.1',
                name: 'Employees',
...
const hasPermission = (permissionList, path) => {
...
const DashboardNav = ({ darkMode, isSidebarOpen, setIsSidebarOpen }) => {
    ...
    const checkPermission = (perm, perms) => {
    ...
    const pathAllowed = path => allowedPaths.has(path);
    const itemHasAnyAllowedChild = item => {
    ...
    const handleDropdownToggle2 = id => {
    ...
    return _jsxs('div', {
        className: `sidebar dark:bg-light-dark bg-light relative overflow-y-auto h-full ${isSidebarOpen ? 'open' : 'closed'}`,
        children: [
            _jsxs('div', {
                ...
                children: [
                    ...
                    _jsx('button', {
                        ...
                        children: _jsx(X, { size: 28, strokeWidth: 1 }),
                    }),
                ],
            }),
            _jsx('ul', {
                className:
                    'space-y-4 mt-28 pb-4 h-[76vh] overflow-y-auto sidebar',
                                                      ...
                                                      children: item.children
                                                          ...
                                                          .map(child =>
                                                              _jsx(
                                                                  ...
                                                                  {
                                                                      className:
                                                                          'bg-gray-100 dark:bg-[#25445b26] rounded text-sm whitespace-nowrap overflow-hidden',
                                                                      children:
                                                                          child?.isDropdown
                                                                              ? _jsxs(
                                                                                    'div',
                                                                                            ...
                                                                                            [
                                                                                                ...
                                                                                                openSubDropdown ===
                                                                                                    ...
                                                                                                    _jsx(
                                                                                                        ...
                                                                                                        {
                                                                                                            className:
                                                                                                                'border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-[#3a678926] border-t',
                                                                                                            children:
                                                                                                                child.children
                                                                                                                    .filter(
                                                                                                                        sc =>
            ...
            _jsx('div', {
                className: `fixed left-0 right-0 bottom-0 p-2`,
                children: _jsx('div', {
                    ...
                    children: _jsxs('div', {
                        ...
                        children: [
                            _jsxs('div', {
                                className:
                                    'flex items-center w-[160px] overflow-hidden',
                                children: [
                                    _jsx('img', {
                                        src: workspace?.image || fallbackImg,
                                        alt: 'User',
                                        className:
                                            'border border-blue-500 rounded-full size-8',
                                    }),
                                    _jsxs('div', {
                                        className:
                                            'flex flex-col gap-0 ml-2 w-[120px] whitespace-nowrap text-xs font-semibold text-md text-mt-3',
                                        children: [
                                            user?.name || '',
                                            _jsx('br', {}),
                                            _jsx('span', {
                            ...
                            _jsx(Button, {
                                ...
                                size: 'small',
                                className:
                                    'flex justify-center items-center hover:bg-red-500 p-0 rounded-full w-[25px] h-[25px] text-white dark:text-black',
