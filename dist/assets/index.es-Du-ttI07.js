import { c as Qe, g as Io } from './index-CwEhBHip.js';
var ht = function (a) {
...
var xi = function (a, e) {
    ...
    ea = typeof document == 'object' && document.all,
    B =
        typeof ea > 'u' && ea !== void 0
            ? function (a) {
                  return typeof a == 'function' || a === ea;
              }
            : function (a) {
    ...
    Fe = function (a, e) {
        return arguments.length < 2 ? Ul(ta[a]) : ta[a] && ta[a][e];
    },
    Gl = L,
    Or = Gl({}.isPrototypeOf),
    zl = _,
...
bn &&
    ((le = bn.split('.')),
    (gr = le[0] > 0 && le[0] < 4 ? 1 : +(le[0] + le[1])));
!gr &&
    ra &&
    ((le = ra.match(/Edge\/(\d+)/)),
    (!le || le[1] >= 74) &&
        ((le = ra.match(/Chrome\/(\d+)/)), le && (gr = +le[1])));
var Ti = gr,
    xn = Ti,
    Hl = D,
    Yl = _,
    ...
    oh = function (a, e) {
        var t, r;
        if (
            (e === 'string' && ia((t = a.toString)) && !na((r = aa(t, a)))) ||
            (ia((t = a.valueOf)) && !na((r = aa(t, a)))) ||
            (e !== 'string' && ia((t = a.toString)) && !na((r = aa(t, a))))
        )
            return r;
...
var Si = zo.exports,
    ...
    z = function (a) {
        return (
            $n(sa, a) || (sa[a] = Sh && $n(Ke, a) ? Ke[a] : $h('Symbol.' + a)),
            sa[a]
        );
    },
    wh = Y,
...
if (bv || fa.state) {
    var de = fa.state || (fa.state = new Ev());
    ((de.get = de.get),
        (de.has = de.has),
        (de.set = de.set),
        (dr = function (a, e) {
...
var Cr = { set: dr, get: Tt, has: pr, enforce: $v, getterFor: wv },
    Ai = L,
    Cv = D,
    Av = B,
    zt = fe,
    ...
    kv = (qo.exports = function (a, e, t) {
        (Mv(_n(e), 0, 7) === 'Symbol(' &&
            ...
            (!zt(a, 'name') || (Pv && a.name !== e)) &&
                (Qa
                    ? ur(a, 'name', { value: e, configurable: !0 })
                    : (a.name = e)),
            Dv &&
                t &&
                zt(t, 'arity') &&
        ...
        try {
            t && zt(t, 'constructor') && t.constructor
                ? Qa && ur(a, 'prototype', { writable: !1 })
                : a.prototype && (a.prototype = void 0);
        } catch {}
        var r = Nv(a);
        return (
            zt(r, 'source') ||
                (r.source = Vv(Lv, typeof e == 'string' ? e : '')),
            a
        );
    });
...
var eu = qo.exports,
    ...
    au = function (a, e) {
        var t = sf(a),
            ...
            i = [],
            n;
        for (n in t) !ca(uf, n) && ca(t, n) && Vn(i, n);
        for (; e.length > r; ) ca(t, (n = e[r++])) && (~of(i, n) || Vn(i, n));
        return i;
    },
    Ri = [
        'constructor',
...
var ff = Fe,
        ...
        ('__proto__' in {}
            ? (function () {
                  var a = !1,
                      ...
                      t;
                  try {
                      ((t = Qf(Object.prototype, '__proto__', 'set')),
                          t(e, []),
    ...
    Rr = function (a, e, t) {
        (a && !t && (a = a.prototype),
            a && !tc(a, Ln) && ec(a, Ln, { configurable: !0, value: e }));
    },
    kn = eu,
    ac = Oe,
    ic = function (a, e, t) {
        return (
            t.get && kn(t.get, e, { getter: !0 }),
            t.set && kn(t.set, e, { setter: !0 }),
            ac.f(a, e, t)
        );
    },
    nc = Fe,
...
if (!Za) {
    var qt = new dg(),
        Qt = function () {
            var a, e;
            for (xa && (a = rs.domain) && a.exit(); (e = qt.get()); )
                try {
                    e();
                } catch (t) {
                    throw (qt.head && Xe(), t);
    ...
    (!pg && !xa && !mg && es && ts
        ? ((Ta = !0),
          (Oa = ts.createTextNode('')),
          new es(Qt).observe(Oa, { characterData: !0 }),
          (Xe = function () {
              Oa.data = Ta = !Ta;
          }))
        : !yg && Xt && Xt.resolve
    ...
    Ag = Eg('Promise', function () {
        ...
        if (!Sa || Sa < 51 || !/native code/.test(a)) {
            var t = new xt(function (n) {
                ...
                i = (t.constructor = {});
            if (((i[Cg] = r), (Ja = t.then(function () {}) instanceof r), !Ja))
                return !0;
        }
        return !e && (is === 'BROWSER' || is === 'DENO') && !Ou;
    }),
    Rt = { CONSTRUCTOR: Ag, REJECTION_EVENT: Ou, SUBCLASSING: Ja },
    ut = {},
    ns = Te,
    Pg = TypeError,
    Rg = function (a) {
        ...
        ((this.promise = new a(function (r, i) {
            if (e !== void 0 || t !== void 0)
                throw new Pg('Bad Promise constructor');
            ((e = r), (t = i));
        })),
            (this.resolve = ns(e)),
            (this.reject = ns(t)));
...
var Ng = ee,
    ...
    Vu = function (a, e, t) {
        ...
        (Yg
            ...
            !Ug && (i = we['on' + a])
                ? i(r)
                : a === Au && Bg('Unhandled promise rejection', t));
    },
    qg = function (a) {
        it(Su, we, function () {
            var e = a.facade,
            ...
            if (
                r &&
                ((i = jg(function () {
                    yr ? ki.emit('unhandledRejection', t, e) : Vu(Au, e, t);
                })),
                (a.rejection = yr || vs(a) ? Ru : Bi),
                i.error)
            )
                throw i.value;
        });
    ...
    Qg = function (a) {
        it(Su, we, function () {
            var e = a.facade;
            yr ? ki.emit('rejectionHandled', e) : Vu(Xg, e, a.value);
        });
    },
    Ze = function (a, e, t) {
        return function (r) {
    ...
    ri = function (a, e, t) {
        if (!a.done) {
            ...
            try {
                if (a.facade === e)
                    throw new Cu("Promise can't be resolved itself");
                var r = Iu(e);
                r
                    ? Di(function () {
                          var i = { done: !1 };
...
var Nt = {},
    ...
    Lu = function (a, e, t) {
        var r = t && t.that,
            ...
            d,
            p = function (x) {
                return (l && ds(l, 'normal'), new vr(!0, x));
            },
            y = function (x) {
                return i
...
Gu.f =
    pp && !yp
        ...
        : function (e, t) {
              bp(e);
              for (var r = xp(t), i = Tp(t), n = i.length, o = 0, s; n > o; )
                  mp.f(e, (s = i[o++]), r[s]);
              return e;
          };
var Op = J,
        ...
        fr =
            typeof document < 'u'
                ? document.domain && Jt
                    ...
                    : Ap()
                : Es(Jt);
        for (var a = Ts.length; a--; ) delete fr[ii][Ts[a]];
        return fr();
    };
Ep[zu] = !0;
var Gi =
...
var ws = Y,
        ...
        if (!n || !o || t) {
            var s = /./[i],
                u = e(i, ''[a], function (l, h, f, c, v) {
                    var g = h.exec;
                    return g === Kp || g === Ca.exec
                        ? n && !v
                            ? { done: !0, value: ws(s, h, f, c) }
                            : { done: !0, value: ws(l, f, h, c) }
                        : { done: !1 };
                });
            (Cs(String.prototype, a, u[0]), Cs(Ca, i, u[1]));
        }
        r && Zp(Ca[i], 'sham', !0);
    },
    Yi = L,
    ...
    hy = !ly(function () {
        ...
        var s = Object.getOwnPropertyDescriptor(Rs.prototype, 'flags').get.call(
            e
        );
        return s !== r || t !== r;
    }),
    ...
    Wi = Ns.correct
        ...
        : function (a) {
              return !Ns.correct && gy(py, a) && !cy(a, 'flags')
                  ? fy(dy, a)
                  : a.flags;
          },
    Is = Y,
...
Ey('match', function (a, e, t) {
    return [
        function (i) {
            ...
            return o ? Oy(o, i, n) : new RegExp(i)[a](er(n));
        },
        function (r) {
            var i = $y(this),
                n = er(r),
            ...
            for (var l = [], h = 0, f; (f = Ms(i, n)) !== null; ) {
                var c = er(f[0]);
                ((l[h] = c),
                    c === '' && (i.lastIndex = Ry(n, Cy(i.lastIndex), u)),
                    h++);
            }
            return h === 0 ? null : l;
        },
        ...
        return [
            ...
            function (i, n) {
                ...
                var h = Me(Qy(o)),
                    f = tr(h, 'g') !== -1,
                    c;
                f && ((c = tr(h, 'u') !== -1), (o.lastIndex = 0));
                for (
                    var v = [], g;
                    (g = Ky(o, s)), !(g === null || (Ra(v, g), !f));
                ...
                for (var p = '', y = 0, x = 0; x < v.length; x++) {
                    ...
                    if (l) {
                        var P = tm([b], $, T, s);
                        (C !== void 0 && Ra(P, C), (E = Me(ky(n, void 0, P))));
                    } else E = qy(b, s, T, $, C, n);
...
gm(
    { target: 'String', proto: !0, forced: !Sm && !Wu },
    {
        startsWith: function (e) {
            ...
            mm(e);
            var r = ym(
                    Om(arguments.length > 1 ? arguments[1] : void 0, t.length)
                ),
                i = ks(e);
...
[].keys &&
    ((Ia = [].keys()),
    'next' in Ia
        ? ((Na = js(js(Ia))), Na !== Object.prototype && (ke = Na))
        : (Qu = !0));
var Fm =
    !km(ke) ||
    Dm(function () {
...
var Ku = { IteratorPrototype: ke, BUGGY_SAFARI_ITERATORS: Qu },
    ...
    s0 = function (a, e, t, r, i, n, o) {
        ...
        if (
            ...
            if (
                ((d = { values: s(gt), keys: n ? c : s(zs), entries: s(Hs) }),
                o)
            )
                for (p in d) (rr || l || !(p in h)) && Ma(h, p, d[p]);
            else qm({ target: e, proto: !0, forced: rr || l }, d);
        return (h[ct] !== c && Ma(h, ct, c, { name: i }), (r0[e] = c), d);
    },
    o0 = function (a, e) {
    ...
    g0 = h0(
        ...
        function () {
            var a = c0(this),
                e = a.target,
                t = a.index++;
            if (!e || t >= e.length) return ((a.target = null), ar(void 0, !0));
            switch (a.kind) {
                case 'keys':
                    return ar(t, !1);
                case 'values':
...
for (var La in rl) al(qs[La] && qs[La].prototype, La);
al(m0, 'DOMTokenList');
function St(a) {
...
Y0(
    ...
    function (a, e, t) {
        var r = '0'.split(void 0, 0).length
            ? function (i, n) {
                  return i === void 0 && n === 0 ? [] : ka(e, this, i, n);
              }
            : e;
        return [
            function (n, o) {
                ...
                return u ? ka(u, n, s, o) : ka(r, to(s), n, o);
            },
            function (i, n) {
                var o = X0(this),
                    s = to(i);
                ...
                for (var g = 0, d = 0, p = []; d < s.length; ) {
                    c.lastIndex = We ? 0 : d;
                    var y = ro(c, We ? ja(s, d) : s),
                        x;
                    if (
                        y === null ||
                        (x = ab(Z0(c.lastIndex + (We ? d : 0)), s.length)) === g
                    )
                        d = K0(s, d, h);
                    else {
                        if ((Ba(p, ja(s, g, d)), p.length === v)) return p;
                        for (var b = 1; b <= y.length - 1; b++)
                            if ((Ba(p, y[b]), p.length === v)) return p;
                        d = g = x;
                    }
                }
                return (Ba(p, ja(s, g)), p);
            },
        ];
    },
    ao || !ib,
...
for (var dt = 0; !nt && dt < ir.length; dt++)
    ((nt = be[ir[dt] + 'Request' + tt]),
        (Et = be[ir[dt] + 'Cancel' + tt] || be[ir[dt] + 'CancelRequest' + tt]));
if (!nt || !Et) {
    var Fa = 0,
        io = 0,
        _e = [],
            ...
            i(function (v, g, d, p) {
                ...
                if (
                    ...
                    if (O === 0)
                        ...
                        ((v.rX =
                            Math.abs(O) /
                            Math.sqrt(q * E(K) + H * M * K + Q * E(M))),
                            (v.rY =
                                Math.abs(O) /
                                Math.sqrt(q * E(M) - H * M * K + Q * E(K))),
            ...
            var s = function (c) {
                ...
                f = i(function (c, v, g) {
                    ...
                    if (
                        ...
                        (p(d.x), y(d.y));
                        for (
                            var x = 0, b = co(v, d.x1, d.x2, d.x);
                            x < b.length;
                            x++
                        )
                            0 < (N = b[x]) &&
                                1 > N &&
                                p(go(v, d.x1, d.x2, d.x, N));
                        for (
                            var T = 0, $ = co(g, d.y1, d.y2, d.y);
                            T < $.length;
                            T++
                        )
                            0 < (N = $[T]) &&
                                1 > N &&
                                y(go(g, d.y1, d.y2, d.y, N));
                    }
                    if (d.type & m.ARC) {
...
function r1(a, e, t, r, i, n) {
    ...
    for (var He = 0; He < r; He++) {
        ...
        for (
            var cn = r, Wr = 0, qr = 0, Qr = 0, Kr = 0, jt = 1;
            jt <= n;
            jt++
        ) {
            b = (cn + He) << 2;
...
class Lr {
    ...
    stop() {
        (this.intervalId &&
            (Ua.cancel(this.intervalId), (this.intervalId = null)),
            this.mouse.stop());
    }
    shouldUpdate(e, t) {
        if (!e) {
    ...
    findSegmentToFitChar(e, t, r, i, n, o, s, u, l) {
        ...
        if (s) {
            var y = Math.cos(Math.PI / 2 + p) * s,
                x = Math.cos(-p) * s;
            ((d.p0 = nr(nr({}, v), {}, { x: v.x + y, y: v.y + x })),
                (d.p1 = nr(nr({}, g), {}, { x: g.x + y, y: g.y + x })));
        }
    ...
    renderChildren(e) {
        ...
        if (r) {
            ...
            if (
                ...
                (n.hasValue() &&
                    (i.attributes.width = new S(t, 'width', n.getString())),
                    o.hasValue() &&
                        (i.attributes.height = new S(
                            t,
                            'height',
                            o.getString()
                        )));
        ...
        if (n) {
            ...
            if (!(h < 1 || f < 1)) {
                var c = Math.floor(n.x),
                    v = Math.floor(n.y),
                    g = this.removeStyles(t, jr.ignoreStyles),
...
class mt {
    constructor(e, t) {
        ...
        ((this.parser = new za(r)),
            (this.screen = new Lr(e, r)),
            (this.options = r));
        var i = new $e(this, r),
