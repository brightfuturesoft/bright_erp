import { c as Qe, g as Ro, _ as xe, a as bi } from './index-LcfjBcbS.js';
var ht = function (a) {
...
var xi = function (a, e) {
    ...
    kl = B,
    ae = function (a) {
        return typeof a == 'object' ? a !== null : kl(a);
    },
    ea = _,
    Bl = B,
    jl = function (a) {
    ...
    Fe = function (a, e) {
        return arguments.length < 2 ? jl(ea[a]) : ea[a] && ea[a][e];
    },
    Fl = L,
    Tr = Fl({}.isPrototypeOf),
    Ul = _,
...
mn &&
    ((le = mn.split('.')),
    (cr = le[0] > 0 && le[0] < 4 ? 1 : +(le[0] + le[1])));
!cr &&
    ta &&
    ((le = ta.match(/Edge\/(\d+)/)),
    (!le || le[1] >= 74) &&
        ((le = ta.match(/Chrome\/(\d+)/)), le && (cr = +le[1])));
var Ti = cr,
    bn = Ti,
    Gl = D,
    zl = _,
    ...
    Yl = Bo,
    jo = Yl && !Symbol.sham && typeof Symbol.iterator == 'symbol',
    Xl = Fe,
    Wl = B,
    ql = Tr,
    Ql = jo,
    ...
    Oi = function (a, e) {
        try {
            sh(xn, a, { value: e, configurable: !0, writable: !0 });
        } catch {
            xn[a] = e;
        }
        return e;
...
var Ei = Uo.exports,
    ...
    Ke = mh.Symbol,
    na = bh('wks'),
    Eh = Oh ? Ke.for || Ke : (Ke && Ke.withoutSetter) || xh,
    z = function (a) {
        return (
            Sn(na, a) || (na[a] = Th && Sn(Ke, a) ? Ke[a] : Eh('Symbol.' + a)),
            na[a]
        );
    },
    Sh = Y,
    ...
    Ho =
        ...
        !Dh(function () {
            return (
                Object.defineProperty(Lh('div'), 'a', {
                    get: function () {
                        return 7;
                    },
                }).a !== 7
...
St.f = kh
    ...
    : function (e, t) {
          ...
          if (zh(e, t)) return Fh(!Bh(jh.f, e, t), e[t]);
      };
var Oe = {},
    Yh = he,
    Xh = D,
...
var rv = he,
    ...
    qo = nv(Wo, 'name'),
    ov = qo && function () {}.name === 'something',
    uv = qo && (!Ya || (Ya && sv(Wo, 'name').configurable)),
    $r = { PROPER: ov, CONFIGURABLE: uv },
    lv = L,
    hv = B,
    Xa = Ei,
...
var $i = Xa.inspectSource,
    fv = _,
    cv = B,
    Rn = fv.WeakMap,
    gv = cv(Rn) && /native code/.test(String(Rn)),
    dv = Si,
    pv = Go,
    Nn = dv('keys'),
    wi = function (a) {
        return Nn[a] || (Nn[a] = pv(a));
    },
    Ci = {},
    yv = gv,
    Qo = _,
    ...
    Sv = function (a) {
        return function (e) {
            var t;
            if (!mv(e) || (t = Tt(e)).type !== a)
                throw new Wa('Incompatible receiver, ' + a + ' required');
            return t;
        };
    };
if (yv || va.state) {
    var de = va.state || (va.state = new Ov());
    ((de.get = de.get),
        (de.has = de.has),
        (de.set = de.set),
        (gr = function (a, e) {
...
var wr = { set: gr, get: Tt, has: dr, enforce: Ev, getterFor: Sv },
    Ai = L,
    $v = D,
    wv = B,
    Gt = fe,
    ...
    Dv = (Xo.exports = function (a, e, t) {
        ...
        return (
            Gt(r, 'source') ||
                (r.source = Mv(Vv, typeof e == 'string' ? e : '')),
            a
        );
    });
...
var Zo = Xo.exports,
    ...
    Ue = function (a, e, t, r) {
        ...
        if ((Lv(t) && Bv(t, n, r), r.global)) i ? (a[e] = t) : jv(e, t);
        else {
            try {
    ...
    tu = function (a, e) {
        var t = af(a),
            ...
            i = [],
            n;
        for (n in t) !fa(sf, n) && fa(t, n) && _n(i, n);
        for (; e.length > r; ) fa(t, (n = e[r++])) && (~nf(i, n) || _n(i, n));
        return i;
    },
    Ri = [
        'constructor',
...
var hf = Fe,
        ...
        if (
            ...
            for (s in e) {
                if (
                    ((l = e[s]),
                    a.dontCallGetSet
                        ? ((h = Af(o, s)), (u = h && h.value))
                        : (u = o[s]),
                    (n = Mf(r ? s : t + (i ? '.' : '#') + s, a.forced)),
                    !n && u !== void 0)
                ) {
                    if (typeof l == typeof u) continue;
                    If(l, u);
                }
                ((a.sham || (u && u.sham)) && Pf(l, 'sham', !0),
                    Rf(o, s, l, a));
            }
    },
    vt = _,
    ...
    Ff = function (a, e, t) {
        try {
            return Bf(jf(Object.getOwnPropertyDescriptor(a, e)[t]));
        } catch {}
    },
    Uf = ae,
    Gf = function (a) {
    ...
    Pr = function (a, e, t) {
        (a && !t && (a = a.prototype),
            a && !Jf(a, Dn) && Zf(a, Dn, { configurable: !0, value: e }));
    },
    Ln = Zo,
    tc = Oe,
    rc = function (a, e, t) {
    ...
    hc = function (a, e) {
        if (uc(e, a)) return a;
        throw new lc('Incorrect invocation');
    },
    vc = z,
    fc = vc('toStringTag'),
    su = {};
su[fc] = 'z';
var cc = String(su) === '[object z]',
    gc = cc,
    dc = B,
    ur = je,
    pc = z,
    ...
    Ni = gc
        ...
        : function (a) {
              ...
              return a === void 0
                  ...
                  : a === null
                    ? 'Null'
                    : typeof (t = xc((e = mc(a)), yc)) == 'string'
                      ? t
                      : bc
                        ? ur(e)
                        : (r = ur(e)) === 'Object' && dc(e.callee)
                          ? 'Arguments'
                          : r;
          },
    Tc = L,
...
var Ac =
    ...
    Ic = function (a) {
        if (Pc(a)) return a;
        throw new Nc(Rc(a) + ' is not a constructor');
    },
    Bn = J,
    Mc = Ic,
    _c = xr,
    ...
    vu = function (a, e) {
        var t = Bn(a).constructor,
            r;
        return t === void 0 || _c((r = Bn(t)[Dc])) ? e : Mc(r);
    },
    Lc = br,
    ...
    Gc = Fe,
    gu = Gc('document', 'documentElement'),
    zc = L,
    Hc = zc([].slice),
    Yc = TypeError,
    Xc = function (a, e) {
    ...
    Wc = wt,
    du = /(?:ipad|iphone|ipod).*applewebkit/i.test(Wc),
    ie = _,
    qc = cu,
    Qc = Mi,
    Gn = B,
...
var _i = function (a) {
    ...
    Qn = function (a) {
        ie.postMessage(ig(a), Ot.protocol + '//' + Ot.host);
    };
(!Qa || !Yn) &&
    ((Qa = function (e) {
...
var $g = Sg('species'),
    Za = !1,
    xu = Tg(xg.PromiseRejectionEvent),
    wg = Og('Promise', function () {
        var a = Eg(xt),
            e = a !== String(xt);
        if (!e && Oa === 66) return !0;
        if (!Oa || Oa < 51 || !/native code/.test(a)) {
            var t = new xt(function (n) {
                ...
                i = (t.constructor = {});
            if (((i[$g] = r), (Za = t.then(function () {}) instanceof r), !Za))
                return !0;
        }
        return !e && (as === 'BROWSER' || as === 'DENO') && !xu;
    }),
    Pt = { CONSTRUCTOR: wg, REJECTION_EVENT: xu, SUBCLASSING: Za },
    ut = {},
    is = Te,
    Cg = TypeError,
    Ag = function (a) {
        ...
        ((this.promise = new a(function (r, i) {
            if (e !== void 0 || t !== void 0)
                throw new Cg('Bad Promise constructor');
            ((e = r), (t = i));
        })),
            (this.resolve = is(e)),
            (this.reject = is(t)));
...
var Pg = ee,
    ...
    ei = Eu.f,
    Gg = ei,
    zg = !!(Ja && Ja.createEvent && we.dispatchEvent),
    wu = 'unhandledrejection',
    Hg = 'rejectionhandled',
    os = 0,
    Cu = 1,
    Yg = 2,
    ...
    Nu = function (a, e) {
        ...
        try {
            i
                ? (r || (e.rejection === Au && Wg(e), (e.rejection = Bi)),
                  i === !0
                      ? (u = t)
                      : (s && s.enter(), (u = i(t)), s && (s.exit(), (h = !0))),
                  u === a.promise
                      ? o(new $u('Promise-chain cycle'))
                      : (l = Ru(u))
                        ? it(l, u, n, o)
                        : n(u))
                : o(t);
    ...
    Iu = function (a, e) {
        a.notified ||
            ...
            Di(function () {
                ...
                ((a.notified = !1), e && !a.rejection && Xg(a));
            }));
    },
    Mu = function (a, e, t) {
        var r, i;
        (zg
            ...
            !jg && (i = we['on' + a])
                ? i(r)
                : a === wu && Lg('Unhandled promise rejection', t));
    },
    Xg = function (a) {
        it(Tu, we, function () {
            var e = a.facade,
            ...
            if (
                r &&
                ((i = kg(function () {
                    pr ? ki.emit('unhandledRejection', t, e) : Mu(wu, e, t);
                })),
                (a.rejection = pr || hs(a) ? Au : Bi),
                i.error)
            )
                throw i.value;
        });
    ...
    Wg = function (a) {
        it(Tu, we, function () {
            var e = a.facade;
            pr ? ki.emit('rejectionHandled', e) : Mu(Hg, e, a.value);
        });
    },
    Ze = function (a, e, t) {
        return function (r) {
...
if (
    ...
    (us = function () {
        var a = new Kt(),
            e = Ea(a);
        ((this.promise = a),
            (this.resolve = Ze(ti, e)),
            (this.reject = Ze(et, e)));
    }),
    (Eu.f = ei =
        function (a) {
            return a === Le || a === Pu ? new us(a) : Gg(a);
        }),
...
Pg({ global: !0, constructor: !0, wrap: !0, forced: Su }, { Promise: Le });
Pu = Rg.Promise;
Ng(Le, Ir, !1);
Ig(Ir);
var Rt = {},
    ...
    Zg = Array.prototype,
    Jg = function (a) {
        return a !== void 0 && (Qg.Array === a || Zg[Kg] === a);
    },
    ed = Ni,
    vs = st,
    td = xr,
    ...
    id = ad('iterator'),
    _u = function (a) {
        if (!td(a)) return vs(a, id) || vs(a, '@@iterator') || rd[ed(a)];
    },
    nd = Y,
    sd = Te,
    od = J,
    ...
    hd = TypeError,
    vd = function (a, e) {
        var t = arguments.length < 2 ? ld(a) : e;
        if (sd(t)) return od(nd(t, a));
        throw new hd(ud(a) + ' is not iterable');
    },
    fd = Y,
    fs = J,
    cd = st,
    ...
    Vu = function (a, e, t) {
        ...
        if (n) l = a.iterator;
            ...
            if (((h = Od(a)), !h)) throw new Ed(md(a) + ' is not iterable');
            if (bd(h)) {
                for (f = 0, c = xd(a); c > f; f++)
                    if (((v = y(a[f])), v && cs(ds, v))) return v;
                return new hr(!1);
            }
            l = Td(a, h);
        }
        for (g = n ? a.next : l.next; !(d = pd(g, l)).done; ) {
            try {
                v = y(d.value);
            } catch (x) {
                gs(l, 'throw', x);
...
var wd = function (a, e) {
    ...
    Dd = ku;
Rd(
    { target: 'Promise', stat: !0, forced: Dd },
    {
        all: function (e) {
            var t = this,
                r = Md.f(t),
...
if (jd(ri)) {
    var ms = Bd('Promise').prototype.catch;
    ys.catch !== ms && Fd(ys, 'catch', ms, { unsafe: !0 });
}
var Ud = ee,
    Gd = Y,
    zd = Te,
...
var Zd = J,
    ...
    ep = ut,
    tp = function (a, e) {
        if ((Zd(a), Jd(e) && e.constructor === a)) return e;
        var t = ep.f(a),
            r = t.resolve;
        return (r(e), t.promise);
    },
...
ap('Promise');
rp(
    { target: 'Promise', stat: !0, forced: ip },
    {
        resolve: function (e) {
            return np(this, e);
        },
...
var hp =
    ...
    ju = { BROKEN_CARET: hp, UNSUPPORTED_Y: Ui },
    Fu = {},
    vp = tu,
    fp = Ri,
    cp =
        ...
        vr =
            typeof document < 'u'
                ? document.domain && Zt
                    ...
                    : wp()
                : Os(Zt);
        for (var a = bs.length; a--; ) delete vr[ai][bs[a]];
        return vr();
    };
Op[Uu] = !0;
var Gi =
...
`) &&
    ...
    Fp = Rp,
    Up = _p,
    Gp = kp('native-string-replace', String.prototype.replace),
...
var zi = ni,
    Wp = ee,
    Es = zi;
Wp({ target: 'RegExp', proto: !0, forced: /./.exec !== Es }, { exec: Es });
var Ss = Y,
    $s = Ue,
    qp = zi,
    ws = D,
        ...
        if (!n || !o || t) {
            var s = /./[i],
                u = e(i, ''[a], function (l, h, f, c, v) {
                    var g = h.exec;
                    return g === qp || g === wa.exec
                        ? n && !v
                            ? { done: !0, value: Ss(s, h, f, c) }
                            : { done: !0, value: Ss(l, f, h, c) }
                        : { done: !1 };
                });
    ...
    uy = !oy(function () {
        ...
        var s = Object.getOwnPropertyDescriptor(As.prototype, 'flags').get.call(
            e
        );
        return s !== r || t !== r;
    }),
    ...
    Wi = Ps.correct
        ...
        : function (a) {
              return !Ps.correct && fy(gy, a) && !vy(a, 'flags')
                  ? hy(cy, a)
                  : a.flags;
          },
    Rs = Y,
    ...
    qi = function (a, e) {
        ...
        if (yy(a) === 'RegExp') return Rs(my, a, e);
        throw new by('RegExp#exec called on incompatible receiver');
    },
    xy = Y,
    Ty = L,
    Oy = Hi,
...
Oy('match', function (a, e, t) {
    return [
        function (i) {
            var n = wy(this),
                o = Sy(i) ? Cy(i, a) : void 0;
            return o ? xy(o, i, n) : new RegExp(i)[a](Jt(n));
        },
        function (r) {
            var i = Ey(this),
                n = Jt(r),
            ...
            var s = Jt(Py(i));
            if (Is(s, 'g') === -1) return Ns(i, n);
            var u = Is(s, 'u') !== -1;
            i.lastIndex = 0;
            for (var l = [], h = 0, f; (f = Ns(i, n)) !== null; ) {
                var c = Jt(f[0]);
                ((l[h] = c),
                    c === '' && (i.lastIndex = Ay(n, $y(i.lastIndex), u)),
                    h++);
            }
            return h === 0 ? null : l;
        },
...
var Qi = L,
    ...
    My = /\$([$&'`]|\d{1,2}|<[^>]*>)/g,
    _y = /\$([$&'`]|\d{1,2})/g,
    Vy = function (a, e, t, r, i, n) {
        var o = t + a.length,
            s = r.length,
            u = _y;
        return (
            i !== void 0 && ((i = Ry(i)), (u = My)),
            Iy(n, u, function (l, h) {
                var f;
                switch (Ca(h, 0)) {
                    case '$':
...
Ly(
    ...
    function (a, e, t) {
        ...
        return [
            function (n, o) {
                var s = zy(this),
                    u = Fy(n) ? Yy(n, ui) : void 0;
                return u ? Ms(u, n, s, o) : Ms(e, Me(s), n, o);
            },
            function (i, n) {
                var o = By(this),
                    s = Me(i);
                ...
                for (
                    var v = [], g;
                    (g = qy(o, s)), !(g === null || (Pa(v, g), !f));

                ) {
                    var d = Me(g[0]);
                    d === '' && (o.lastIndex = Hy(s, Gy(o.lastIndex), c));
                }
                for (var p = '', y = 0, x = 0; x < v.length; x++) {
                    g = v[x];
                    for (
                        var b = Me(g[0]),
                            T = Ky(Zy(Uy(g.index), s.length), 0),
                            $ = [],
                            S,
                            O = 1;
                        O < g.length;
                    ...
                    if (l) {
                        var P = Jy([b], $, T, s);
                        (C !== void 0 && Pa(P, C), (S = Me(Dy(n, void 0, P))));
                    } else S = Xy(b, s, T, $, C, n);
                    T >= y && ((p += _s(s, y, T) + S), (y = T + b.length));
                }
                return p + _s(s, y);
            },
        ];
...
var am = ae,
    ...
    om = function (a) {
        var e;
        return am(a) && ((e = a[sm]) !== void 0 ? !!e : im(a) === 'RegExp');
    },
    um = om,
    lm = TypeError,
    Ki = function (a) {
        if (um(a))
            throw new lm("The method doesn't accept regular expressions");
        return a;
    },
    hm = z,
    vm = hm('match'),
    ...
    Tm =
        !Yu &&
        !!(function () {
            var a = gm(String.prototype, 'startsWith');
            return a && !a.writable;
        })();
fm(
    { target: 'String', proto: !0, forced: !Tm && !Yu },
    {
        startsWith: function (e) {
            var t = Ds(ym(this));
            pm(e);
            var r = dm(
                    xm(arguments.length > 1 ? arguments[1] : void 0, t.length)
                ),
                i = Ds(e);
            return bm(t, r, r + i.length) === i;
        },
    }
);
var Om = z,
    ...
    li = Om('unscopables'),
    hi = Array.prototype;
hi[li] === void 0 && Sm(hi, li, { configurable: !0, value: Em(null) });
var $m = function (a) {
        hi[li][a] = !0;
    },
    wm = D,
...
[].keys &&
    ((Na = [].keys()),
    'next' in Na
        ? ((Ra = ks(ks(Na))), Ra !== Object.prototype && (ke = Ra))
        : (Wu = !0));
var Bm =
    !Dm(ke) ||
    _m(function () {
...
var qu = { IteratorPrototype: ke, BUGGY_SAFARI_ITERATORS: Wu },
    ...
    t0 = Qu.PROPER,
    r0 = Qu.CONFIGURABLE,
    Fs = Ku.IteratorPrototype,
    tr = Ku.BUGGY_SAFARI_ITERATORS,
    ct = Jm('iterator'),
    Us = 'keys',
    gt = 'values',
    Gs = 'entries',
    ...
    i0 = function (a, e, t, r, i, n, o) {
        ...
        if (
            ...
            if (
                ((d = { values: s(gt), keys: n ? c : s(Us), entries: s(Gs) }),
                o)
            )
                for (p in d) (tr || l || !(p in h)) && Ia(h, p, d[p]);
            else Xm({ target: e, proto: !0, forced: tr || l }, d);
        return (h[ct] !== c && Ia(h, ct, c, { name: i }), (e0[e] = c), d);
    },
    n0 = function (a, e) {
    ...
    f0 = u0(
        ...
        'Array',
        function (a, e) {
            h0(this, { type: Ju, target: s0(a), index: 0, kind: e });
        },
        function () {
            var a = v0(this),
                e = a.target,
    ...
    Hs = (zs.Arguments = zs.Array);
Ji('keys');
Ji('values');
Ji('entries');
if (l0 && Hs.name !== 'values')
    try {
        o0(Hs, 'name', { value: 'values' });
    } catch {}
var c0 = {
        CSSRuleList: 0,
    ...
    g0 = Sr,
    Ma = g0('span').classList,
    Ys = Ma && Ma.constructor && Ma.constructor.prototype,
    d0 = Ys === Object.prototype ? void 0 : Ys,
    Xs = _,
    el = c0,
    p0 = d0,
    pt = f0,
...
for (var Da in el) tl(Xs[Da] && Xs[Da].prototype, Da);
tl(p0, 'DOMTokenList');
var b0 = Te,
    x0 = Er,
    T0 = Lo,
    ...
    E0 = function (a) {
        return function (e, t, r, i) {
            var n = x0(e),
                o = T0(n),
                s = O0(n);
            if ((b0(t), s === 0 && r < 2)) throw new qs(Qs);
            var u = a ? s - 1 : 0,
                l = a ? -1 : 1;
            if (r < 2)
                for (;;) {
...
var I0 = ee,
    ...
    F0 =
        !al &&
        !!(function () {
            var a = _0(String.prototype, 'endsWith');
            return a && !a.writable;
        })();
I0(
    { target: 'String', proto: !0, forced: !F0 && !al },
    {
        endsWith: function (e) {
            var t = Zs(L0(this));
            D0(e);
            var r = arguments.length > 1 ? arguments[1] : void 0,
                i = t.length,
                n = r === void 0 ? i : j0(V0(r), i),
                o = Zs(e);
            return B0(t, n - o.length, n) === o;
        },
    }
);
var La = Y,
...
U0(
    ...
    function (a, e, t) {
        ...
        return [
            function (n, o) {
                var s = H0(this),
                    u = z0(n) ? q0(n, a) : void 0;
                return u ? La(u, n, s, o) : La(r, Js(s), n, o);
            },
            function (i, n) {
                var o = G0(this),
                    s = Js(i);
                ...
                var l = Y0(o, RegExp),
                    ...
                    v = n === void 0 ? Z0 : n >>> 0;
                if (v === 0) return [];
                if (s.length === 0) return eo(c, s) === null ? [s] : [];
                for (var g = 0, d = 0, p = []; d < s.length; ) {
                    c.lastIndex = We ? 0 : d;
                    var y = eo(c, We ? Ba(s, d) : s),
                        x;
                    if (
                        y === null ||
                        (x = J0(W0(c.lastIndex + (We ? d : 0)), s.length)) === g
                    )
                        d = X0(s, d, h);
                    else {
...
var tb = yt.exports,
    ...
    tt = 'AnimationFrame',
    nt = be['request' + tt],
    Et = be['cancel' + tt] || be['cancelRequest' + tt];
for (var dt = 0; !nt && dt < ar.length; dt++)
    ((nt = be[ar[dt] + 'Request' + tt]),
        (Et = be[ar[dt] + 'Cancel' + tt] || be[ar[dt] + 'CancelRequest' + tt]));
if (!nt || !Et) {
    var ja = 0,
        ro = 0,
        _e = [],
    ...
    ((nt = function (a) {
        ...
        return (_e.push({ handle: ++ro, callback: a, cancelled: !1 }), ro);
    }),
        (Et = function (a) {
...
Vr.exports.polyfill = function (a) {
    (a || (a = be),
        (a.requestAnimationFrame = nt),
        (a.cancelAnimationFrame = Et));
};
var ib = Vr.exports;
const Fa = Ro(ib);
var nl = `	
\v\f\r                　\u2028\u2029\uFEFF`,
    ...
    gb = function (a) {
        return cb(function () {
            return !!io[a]() || no[a]() !== no || (fb && io[a].name !== a);
        });
    },
    db = ee,
    pb = vb.trim,
    yb = gb;
db(
    { target: 'String', proto: !0, forced: yb('trim') },
    {
        trim: function () {
            return pb(this);
        },
...
bb(
    { target: 'Array', proto: !0, forced: Eb },
    {
        indexOf: function (e) {
            ...
            return sl ? di(this, e, t) || 0 : Tb(this, e, t);
        },
    }
);
var Sb = ee,
    ...
    Pb = $b(''.indexOf);
Sb(
    { target: 'String', proto: !0, forced: !Ab('includes') },
    {
        includes: function (e) {
            return !!~Pb(
                so(Cb(this)),
...
Ib(
    ...
    {
        reverse: function () {
            return (_b(this) && (this.length = this.length), Vb(this));
        },
    }
);
/*! *****************************************************************************
...
function Ua(a, e, t) {
    ...
    var s = pi([(e - n) / 2, (t - o) / 2], (-a.xRot / 180) * Se),
        u = s[0],
        l = s[1],
        h = Math.pow(u, 2) / Math.pow(r, 2) + Math.pow(l, 2) / Math.pow(i, 2);
    (1 < h && ((r *= Math.sqrt(h)), (i *= Math.sqrt(h))),
        (a.rX = r),
        (a.rY = i));
    var f = Math.pow(r, 2) * Math.pow(l, 2) + Math.pow(i, 2) * Math.pow(u, 2),
        ...
        v = ((r * l) / i) * c,
        g = ((-i * u) / r) * c,
        d = pi([v, g], (a.xRot / 180) * Se);
    ((a.cX = d[0] + (e + n) / 2),
        (a.cY = d[1] + (t + o) / 2),
        (a.phi1 = Math.atan2((l - g) / i, (u - v) / r)),
        (a.phi2 = Math.atan2((-l - g) / i, (-u - v) / r)),
        a.sweepFlag === 0 && a.phi2 > a.phi1 && (a.phi2 -= 2 * Se),
        a.sweepFlag === 1 && a.phi2 < a.phi1 && (a.phi2 += 2 * Se),
        (a.phi1 *= 180 / Se),
        (a.phi2 *= 180 / Se));
}
function uo(a, e, t) {
            ...
            i(function (v, g, d, p) {
                ...
                if (
                    ...
                    if (O === 0)
                        ...
                        ((v.rX =
                            Math.abs(O) /
                            Math.sqrt(q * S(K) + H * M * K + Q * S(M))),
                            (v.rY =
                                Math.abs(O) /
                                Math.sqrt(q * S(M) - H * M * K + Q * S(K))),
            ...
            return i(function (c, v, g, d, p) {
                ...
                if (
                    ...
                    var $ = c.x === void 0 ? 0 : c.relative ? c.x : c.x - v,
                        S = c.y === void 0 ? 0 : c.relative ? c.y : c.y - g;
                    ((b = isNaN(h)
                        ? c.x1 === void 0
                            ? b
                            : c.relative
                ...
                return m.ARC === s.type
                    ? (function (h, f, c) {
                          ...
                          for (
                              ...
                              var C = lo(h.phi1, h.phi2, O / b),
                                  P = lo(h.phi1, h.phi2, (O + 1) / b),
                                  V = P - C,
                              ...
                              var K = function (se, ge) {
                                  var Ee = pi([se * h.rX, ge * h.rY], h.xRot),
                                      ze = Ee[0],
                                      It = Ee[1];
            ...
            var s = function (c) {
                ...
                f = i(function (c, v, g) {
                    ...
                    if (
                        ...
                        (p(d.x), y(d.y));
                        for (
                            var x = 0, b = vo(v, d.x1, d.x2, d.x);
                            x < b.length;
                            x++
                        )
                            0 < (N = b[x]) &&
                                1 > N &&
                                p(fo(v, d.x1, d.x2, d.x, N));
                        for (
                            var T = 0, $ = vo(g, d.y1, d.y2, d.y);
                            T < $.length;
                            T++
                        )
                            0 < (N = $[T]) &&
                                1 > N &&
                                y(fo(g, d.y1, d.y2, d.y, N));
                    }
                    if (d.type & m.ARC) {
                        (p(d.x), y(d.y), Ua(d, v, g));
                        for (
                            var S = (d.xRot / 180) * Math.PI,
                                O = Math.cos(S) * d.rX,
                                C = Math.sin(S) * d.rX,
                                P = -Math.sin(S) * d.rY,
                                V = Math.cos(S) * d.rY,
                            ...
                            (N = q[G]) > R && N < X && p(ho(d.cX, O, P, N));
                        for (
                            var H = 0, Q = uo(V, -C, 0).map(W);
                            H < Q.length;
                            H++
                        ) {
                            var N;
                            (N = Q[H]) > R && N < X && y(ho(d.cY, C, V, N));
                        }
                    }
                    return c;
                });
...
function Zb(a, e, t, r, i, n) {
    for (
        ...
        ((v = v.next = new po()), d === h && (g = v));
    v.next = c;
    for (
        var p = null, y = null, x = 0, b = 0, T = Wb[n], $ = qb[n], S = 0;
        S < i;
        S++
    ) {
        v = c;
    ...
    for (var He = 0; He < r; He++) {
        ...
        for (
            var fn = r, Xr = 0, Wr = 0, qr = 0, Qr = 0, Bt = 1;
            Bt <= n;
            Bt++
        ) {
            b = (fn + He) << 2;
...
var f2 = Object.freeze({ __proto__: null, offscreen: Jb, node: e1 });
function lt(a) {
...
var a1 = /^[A-Z-]+$/;
function i1(a) {
    return a1.test(a) ? a.toLowerCase() : a;
}
function fl(a) {
    var e = /url\(('([^']+)'|"([^"]+)"|([^'")]+))\)/.exec(a) || [];
    return e[2] || e[3] || e[4];
...
var s1 = /(\[[^\]]+\])/g,
    o1 = /(#[^\s+>~.[:]+)/g,
    u1 = /(\.[^\s+>~.[:]+)/g,
    l1 = /(::[^\s+>~.[:]+|:first-line|:first-letter|:before|:after)/gi,
    h1 = /(:[\w-]+\([^)]*\))/gi,
    v1 = /(:[^\s+>~.[:]+)/g,
    f1 = /([^\s+>~.[:]+)/g;
function Ve(a, e) {
    ...
    getColor(e) {
        ...
        return (
            this.isNormalizedColor ||
                ((this.isNormalizedColor = !0), (t = n1(t)), (this.value = t)),
            t
        );
    }
    getDpi() {
...
class Dr {
    constructor(e) {
        ...
        ((this.ctx = e),
            ...
            (this.viewPort = new g1()),
            (this.mouse = new d1(this)),
            (this.animations = []),
            (this.waits = []),
    ...
    setViewBox(e) {
        ...
        (T === 'meet' && ((P *= O), (V *= O)),
            T === 'slice' && ((P *= C), (V *= C)));
        var j = new E(t, 'refX', f),
            R = new E(t, 'refY', c),
            X = j.hasValue() && R.hasValue();
        if (
            (X && r.translate(-O * j.getPixels('x'), -O * R.getPixels('y')), v)
        ) {
            var W = O * g,
                G = O * d;
            (r.beginPath(),
    ...
    stop() {
        (this.intervalId &&
            (Fa.cancel(this.intervalId), (this.intervalId = null)),
            this.mouse.stop());
    }
    shouldUpdate(e, t) {
        if (!e) {
...
Dr.defaultWindow = cl;
Dr.defaultFetch = gl;
var { defaultFetch: p1 } = Dr,
    y1 = typeof DOMParser < 'u' ? DOMParser : null;
class Ga {
    constructor() {
        var { fetch: e = p1, DOMParser: t = y1 } =
            arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
...
function C1(a) {
    return typeof process > 'u' ? a : a.trim().split(',').map(w1).join(',');
}
function A1(a) {
    if (!a) return '';
...
class Ge extends I {
    ...
    setContext(e) {
        ...
        if (!t) {
            ...
            if (i.hasValue()) {
                var l = new E(this.document, 'fill', e.fillStyle)
                    .addOpacity(i)
                    .getColor();
                e.fillStyle = l;
            }
            ...
            if (o.hasValue()) {
                var c = new E(this.document, 'stroke', e.strokeStyle)
                    .addOpacity(o)
                    .getString();
                e.strokeStyle = c;
            }
...
class Ce extends Ge {
    ...
    getTextFromNode(e) {
        var t = e || this.node,
            ...
            n = r.length - 1,
            o = lt(t.textContent || '');
        return (i === 0 && (o = t1(o)), i === n && (o = r1(o)), o);
    }
    renderChildren(e) {
        if (this.type !== 'text') {
...
class V1 extends I {
    ...
    createPattern(e, t, r) {
        ...
        ((o.attributes.viewBox = new E(
            this.document,
            'viewBox',
            this.getAttribute('viewBox').getValue()
        )),
            (o.attributes.width = new E(
                this.document,
                'width',
                ''.concat(i, 'px')
            )),
            (o.attributes.height = new E(
                this.document,
                'height',
                ''.concat(n, 'px')
            )),
            (o.attributes.transform = new E(
                this.document,
                'transform',
        ...
        for (var f = -1; f <= 1; f++)
            for (var c = -1; c <= 1; c++)
                (u.save(),
                    (o.attributes.x = new E(this.document, 'x', f * s.width)),
                    (o.attributes.y = new E(this.document, 'y', c * s.height)),
                    o.render(u),
                    u.restore());
    ...
    createGradient(e, t, r) {
        ...
        if (
            ...
            var { document: s } = this,
                ...
                [h] = l.viewPorts,
                f = new ml(s, null);
            ((f.attributes.x = new E(s, 'x', -u / 3)),
                (f.attributes.y = new E(s, 'y', -u / 3)),
                (f.attributes.width = new E(s, 'width', u)),
                (f.attributes.height = new E(s, 'height', u)));
            var c = new tn(s, null);
            ((c.attributes.transform = new E(
                s,
                'transform',
                ...
                (c.children = [f]));
            var v = new Nt(s, null);
            ((v.attributes.x = new E(s, 'x', 0)),
                (v.attributes.y = new E(s, 'y', 0)),
                (v.attributes.width = new E(s, 'width', h.width)),
                (v.attributes.height = new E(s, 'height', h.height)),
                (v.children = [c]));
...
class rn extends I {
    constructor(e, t, r) {
        (super(e, t, r),
            ...
            (this.values = new E(e, 'values', null)));
    ...
    getProgress() {
        ...
        if (t.hasValue()) {
            var i = r.progress * (t.getValue().length - 1),
                n = Math.floor(i),
                o = Math.ceil(i);
            ((r.from = new E(e, 'from', parseFloat(t.getValue()[n]))),
                (r.to = new E(e, 'to', parseFloat(t.getValue()[o]))),
                (r.progress = (i - n) / (o - n)));
    ...
    renderChildren(e) {
        if (this.hasText) {
            ...
            var { document: t, x: r, y: i } = this,
                { mouse: n } = t.screen,
                o = new E(t, 'fontSize', Z.parse(t.ctx.font).fontSize);
            n.isWorking() &&
                n.checkBoundingBox(
                    this,
...
class W1 extends Ce {
    ...
    setTextData(e) {
        if (!this.glyphInfo) {
            ...
            var g = f.reduce((T, $, S) => (S === 0 ? 0 : T + $ || 0), 0),
    ...
    getPointOnCubicBezier(e, t, r, i, n, o, s, u, l) {
        var h = u * bo(e) + o * xo(e) + i * To(e) + t * Oo(e),
            f = l * bo(e) + s * xo(e) + n * To(e) + r * Oo(e);
        return { x: h, y: f };
    }
    getPointOnQuadraticBezier(e, t, r, i, n, o, s) {
        var u = o * Eo(e) + i * So(e) + t * $o(e),
            l = s * Eo(e) + n * So(e) + r * $o(e);
        return { x: u, y: l };
    }
    ...
    renderChildren(e) {
        ...
        if (r) {
            ...
            if (
                ...
                (n.hasValue() &&
                    (i.attributes.width = new E(t, 'width', n.getString())),
                    o.hasValue() &&
                        (i.attributes.height = new E(
                            t,
                            'height',
                            o.getString()
                        )));
...
class e2 extends I {
    ...
    apply(e) {
        ...
        (r && ((r.beginPath = Co), (r.closePath = Co)),
            Reflect.apply(i, e, []),
...
class $e {
    ...
    createElement(e) {
        var t = e.nodeName.replace(/^[^:]+:/, ''),
            r = $e.elementTypes[t];
        return typeof r < 'u' ? new r(this, e) : new $1(this, e);
    }
    createTextNode(e) {
        return new R1(this, e);
    }
    setViewBox(e) {
        this.screen.setViewBox(u2({ document: this }, e));
    }
}
$e.createCanvas = l2;
$e.createImage = h2;
...
export {
    X1 as AElement,
    F1 as AnimateColorElement,
    rn as AnimateElement,
    U1 as AnimateTransformElement,
    ce as BoundingBox,
    bo as CB1,
    xo as CB2,
    To as CB3,
    ...
    mt as Canvg,
    N1 as CircleElement,
    e2 as ClipPathElement,
    L1 as DefsElement,
    s2 as DescElement,
    $e as Document,
    I as Element,
    I1 as EllipseElement,
    Ol as FeColorMatrixElement,
    a2 as FeCompositeElement,
    t2 as FeDropShadowElement,
    i2 as FeGaussianBlurElement,
    r2 as FeMorphologyElement,
    Br as FilterElement,
    Z as Font,
    G1 as FontElement,
    ...
    Q1 as ImageElement,
    M1 as LineElement,
    k1 as LinearGradientElement,
    D1 as MarkerElement,
    kr as MaskElement,
    dl as Matrix,
    H1 as MissingGlyphElement,
    d1 as Mouse,
    rt as PSEUDO_ZERO,
    Ga as Parser,
    A as PathElement,
    w as PathParser,
    V1 as PatternElement,
    k as Point,
    _1 as PolygonElement,
    bl as PolylineElement,
    E as Property,
    Eo as QB1,
    So as QB2,
    $o as QB3,
    B1 as RadialGradientElement,
    ml as RectElement,
    ...
    mt as default,
    c1 as getSelectorSpecificity,
    i1 as normalizeAttributeName,
    n1 as normalizeColor,
