...
var mt = E([
    ...
    pr = function (n, o) {
        ...
        try {
            ...
            return (
                console.warn(
                    'TrustedTypes policy ' + g + ' could not be created.'
                ),
                null
            );
        }
...
function _t() {
    ...
    if (typeof g == 'function') {
        ...
        ce.content &&
            ce.content.ownerDocument &&
            (s = ce.content.ownerDocument);
    }
    var R = pr(K, o),
        me = R ? R.createHTML('') : '',
        J = s,
            ...
            ($ && $ === e) ||
                ...
                (Re =
                    'ALLOWED_NAMESPACES' in e
                        ? l({}, e.ALLOWED_NAMESPACES, we)
                        : It),
                (be =
                    'ADD_URI_SAFE_ATTR' in e
                        ? l(U(Je), e.ADD_URI_SAFE_ATTR, T)
                        : Je),
                (Ke =
                    'ADD_DATA_URI_TAGS' in e
                        ? l(U(Ze), e.ADD_DATA_URI_TAGS, T)
                        : Ze),
    ...
    var Ut = function (e) {
            var t = fe(e);
            (!t || !t.tagName) &&
                (t = { namespaceURI: B, tagName: 'template' });
            var r = se(e.tagName),
                u = se(t.tagName);
        ...
        nt = function (e) {
            ...
            return (e instanceof D && !Ut(e)) ||
                ...
                : (H &&
                      ...
                      (t = L(t, ve, ' ')),
                      e.textContent !== t &&
                          (q(n.removed, { element: e.cloneNode() }),
                          (e.textContent = t))),
                            ...
                            !(
                                (ot(e) &&
                                    ...
                                    ((f.attributeNameCheck instanceof RegExp &&
                                        ...
                                        (f.attributeNameCheck instanceof
                                            Function &&
        ...
        (n.sanitize = function (i) {
            ...
            for (var F = at(X ? i : t); (u = F.nextNode()); )
                (u.nodeType === 3 && u === A) ||
                    (nt(u),
                    lt(u),
                    u.content instanceof c && Ht(u.content),
                    (A = u));
