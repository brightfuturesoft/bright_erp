...
const PaymentLayout = () => {
    const [payment_method, set_payment_method] = useState('Bank Transfer');
    ...
    const handleFileChange = e => {
        if (e.target.files && e.target.files[0]) {
            setFormData(prevState => ({
                ...prevState,
                clearanceInput: e.target.files[0],
            }));
        }
    };
    ...
    return _jsxs('div', {
        className: 'bg-light dark:bg-dark pb-20 min-h-screen overflow-y-auto',
        children: [
            _jsx(HomeNav, {}),
            _jsxs('div', {
                className: 'mx-auto mt-20 px-4 sm:px-6 lg:px-8 pt-6 max-w-7xl',
                children: [
                    _jsx('h1', {
                        className:
                            'pb-8 font-bold text-2xl text-center md:text-4xl dark:text-white',
                        children: 'Checkout',
                    }),
                    _jsxs('div', {
                        className:
                        ...
                        children: [
                            ...
                            _jsxs('button', {
                                onClick: () =>
                                    onToggle({ target: { value: 'Visa' } }),
                                type: 'button',
                                className:
                                    'inline-flex justify-center items-center border-gray-200 dark:border-gray-700 bg-white hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-light-dark mr-2 mb-2 px-5 py-2.5 border rounded-lg w-full md:w-auto font-medium text-center text-gray-900 focus:ring-4 focus:ring-gray-100 text-sm dark:focus:ring-gray-600 dark:text-white duration-200',
                                children: [
                                    _jsxs('svg', {
                            ...
                            _jsxs('button', {
                                ...
                                type: 'button',
                                className:
                                    'flex flex justify-center items-center gap-2 border-gray-200 dark:border-gray-700 bg-white hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-light-dark mr-2 mb-2 px-5 py-2.5 border rounded-lg w-full md:w-auto font-medium text-center text-gray-900 focus:ring-4 focus:ring-gray-100 text-sm dark:focus:ring-gray-600 dark:text-white duration-200 items',
                                children: [
                                    _jsx(BankOutlined, {
                                        className: 'text-lg',
                                    }),
            ...
            _jsx('div', {
                ...
                children: _jsxs('div', {
                    className: 'bg-[#F9FAFB] dark:bg-gray-800 p-6 rounded-lg',
                    children: [
                        payment_method === 'Bank Transfer' &&
                            _jsxs(_Fragment, {
                                children: [
                                    _jsx('h1', {
                                        className:
                                            'pb-8 font-bold text-start text-xl dark:text-white',
                                        children: 'Bank Transfer',
                                    }),
                                    _jsxs('div', {
                                        className:
                                            'bg-dark mb-3 p-2 rounded-lg',
                                        children: [
                                            _jsx('h1', {
                                        ...
                                        children: [
                                                ...
                                                children: [
                                                    ...
                                                    _jsx('input', {
                                                        ...
                                                        placeholder:
                                                            '111 111 111',
                                                        className:
                                                            'border-gray-300 focus:border-indigo-500 bg-light dark:bg-light-dark shadow-sm mt-1 p-2 border rounded-md w-full focus:outline-none focus:ring-indigo-500 dark:text-white',
                                                    }),
                                                ],
                                            }),
                                            _jsxs('div', {
                                            ...
                                            _jsx('div', {
                                                children: _jsx('button', {
                                                    type: 'submit',
                                                    className:
                                                        'bg-indigo-600 hover:bg-indigo-700 shadow-sm px-4 py-2 border border-transparent rounded-md w-full font-medium text-sm text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500',
                                                    children: 'Pay Now',
                                                }),
                                            }),
                                        ],
                                        ...
                                        children: [
                                            ...
                                            _jsx('div', {
                                                children: _jsx('button', {
                                                    type: 'submit',
                                                    className:
                                                        'bg-pink-600 hover:bg-pink-700 shadow-sm px-4 py-2 border border-transparent rounded-md w-full font-medium text-sm text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500',
                                                    children: 'Pay Now',
                                                }),
                                            }),
                                        ],
                        ...
                        ['Visa', 'Mastercard'].includes(payment_method) &&
                            _jsx(Elements, {
                                ...
                                children: _jsx(StripePaymentForm, {}),
                            }),
                    ],
                }),
            }),
