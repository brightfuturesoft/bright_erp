                                ...
                                <div className="space-y-8 lg:mb-0 mb-6">
                                    <div className="rounded-lg border dark:text-light text-black dark:bg-light-dark bg-[white] text-card-foreground shadow-sm">
                                        ...
                                        <div className="flex items-center lg:p-6 p-2">
                                            <Link to={`/pricing/payment`} className="inline-flex items-center bg-slate-950 text-white justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-10 px-4 py-2 w-full">
                                                Complete Purchase
                                            </Link>
                                        </div>
                                    </div>
