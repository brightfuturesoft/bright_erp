    ...
    return (
        <div>
                    ...
                    <nav className="relative flex items-center justify-between h-16 lg:h-20">
                        ...
                        <div className="lg:hidden flex gap-2 items-center ml-auto">
                            {!user && <NavLink
                                to={`/signin`}
                                className={({ isActive }) =>
                                    `text-base font-medium ${isActive ? 'text-blue-500 dark:' : 'text-light dark:text-light'} bg-primary  py-2 px-6 rounded-lg`
                                }
                            >
                                Sign in
                            </NavLink>}
            ...
            <Drawer
                ...
                title="Menu" placement="left" onClose={onClose} visible={visible}>
                <div className="flex flex-col space-y-2">
                    {navLinks.map(link => (
                        <NavLink
                            ...
                            to={link.path}
                            className={({ isActive }) =>
                                `py-2 text-base font-medium ${isActive ? 'text-blue-600' : 'dark:!text-light text-black'} transition-all duration-200`
                            }
                            onClick={onClose}
                        >
                            {link.name}
