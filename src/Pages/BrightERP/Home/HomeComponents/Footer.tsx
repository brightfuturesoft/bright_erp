                            ...
                            <li>
                                ...
                                >
                                    <svg
                                        ...
                                        fill="currentColor"
                                    >
                                        <path d="M22 12a10 10 0 1 0-11.5 9.95v-7.05h-2.7v-2.9h2.7V9.8c0-2.66 1.58-4.14 4-4.14 1.16 0 2.38.2 2.38.2v2.62h-1.34c-1.32 0-1.73.82-1.73 1.66v2h2.95l-.47 2.9h-2.48V22A10 10 0 0 0 22 12z" />
                                    </svg>
                                </a>
                            </li>
                            ...
                            <li>
                                ...
                                >
                                    <svg
                                        ...
                                        fill="currentColor"
                                    >
                                        <path d="M12 2.2c3.2 0 3.584.012 4.85.07 1.17.056 1.97.24 2.43.402a4.92 4.92 0 0 1 1.77 1.036 4.92 4.92 0 0 1 1.036 1.77c.162.46.346 1.26.402 2.43.058 1.266.07 1.65.07 4.85s-.012 3.584-.07 4.85c-.056 1.17-.24 1.97-.402 2.43a4.92 4.92 0 0 1-1.036 1.77 4.92 4.92 0 0 1-1.77 1.036c-.46.162-1.26.346-2.43.402-1.266.058-1.65.07-4.85.07s-3.584-.012-4.85-.07c-1.17-.056-1.97-.24-2.43-.402a4.92 4.92 0 0 1-1.77-1.036 4.92 4.92 0 0 1-1.036-1.77c-.162-.46-.346-1.26-.402-2.43C2.212 15.584 2.2 15.2 2.2 12s.012-3.584.07-4.85c.056-1.17.24-1.97.402-2.43a4.92 4.92 0 0 1 1.036-1.77 4.92 4.92 0 0 1 1.77-1.036c.46-.162 1.26-.346 2.43-.402C8.416 2.212 8.8 2.2 12 2.2zm0-2.2C8.735 0 8.332.012 7.052.07 5.782.128 4.842.308 4.042.573a7.1 7.1 0 0 0-2.565 1.65A7.1 7.1 0 0 0 .573 4.042c-.265.8-.445 1.74-.503 3.01C.012 8.332 0 8.735 0 12s.012 3.668.07 4.948c.058 1.27.238 2.21.503 3.01a7.1 7.1 0 0 0 1.65 2.565 7.1 7.1 0 0 0 2.565 1.65c.8.265 1.74.445 3.01.503C8.332 23.988 8.735 24 12 24s3.668-.012 4.948-.07c1.27-.058 2.21-.238 3.01-.503a7.1 7.1 0 0 0 2.565-1.65 7.1 7.1 0 0 0 1.65-2.565c.265-.8.445-1.74.503-3.01.058-1.28.07-1.683.07-4.948s-.012-3.668-.07-4.948c-.058-1.27-.238-2.21-.503-3.01a7.1 7.1 0 0 0-1.65-2.565 7.1 7.1 0 0 0-2.565-1.65c-.8-.265-1.74-.445-3.01-.503C15.668.012 15.265 0 12 0zM12 5.838a6.162 6.162 0 1 0 0 12.324 6.162 6.162 0 0 0 0-12.324zm0 10.162a3.998 3.998 0 1 1 0-7.996 3.998 3.998 0 0 1 0 7.996zm6.406-11.845a1.44 1.44 0 1 0 0 2.88 1.44 1.44 0 0 0 0-2.88z" />
                                    </svg>
                                </a>
                            </li>
