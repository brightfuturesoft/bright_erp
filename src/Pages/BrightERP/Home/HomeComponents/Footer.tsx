        ...
        <div className="gap-x-12 gap-y-16 grid grid-cols-2 lg:grid-cols-6 md:col-span-3">
            ...
            <div className="">
              <div className="dark:block flex-shrink-0 hidden">
                <Link to="/" className="flex">
                  <img className="w-[140px]" src={logoLight} alt="" />
                </Link>
              </div>
              <div className="block flex-shrink-0 dark:hidden">
                <Link to="/" className="flex">
                  <img className="w-[140px]" src={logoDark} alt="" />
                </Link>
              </div>
            </div>
          ...
          <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
            ...
            <form action="#" method="POST" className="mt-6">
              ...
              <button
                type="submit"
                className="inline-flex justify-center items-center bg-blue-600 dark:hover:bg-gray-700 hover:bg-blue-700 focus:bg-blue-700 dark:bg-light-dark mt-3 px-6 py-2 rounded-md font-semibold text-white transition-all duration-200"
              >
                Subscribe
              </button>
            </form>
