    ...
    const benefits = [
        {
            ...
            description: "Using our free GST accounting and billing software, you can seamlessly create custom invoices. Further, you can manage your dashboard and track inventory items. The free access provides you use many other useful features.",
            icon: "🔒",
        },
        {
        ...
        },
        {
            ...
            description: "GST billing & accounting software allows businesses to record transactions. It helps track payments. Over 1 crore businesses have tried out our free billing management software features. Cashflow management is widely used for their billing, accounting, and many more.",
            icon: "💵",
        },
        {
        ...
        },
        {
            ...
            description: "Your customers are less likely to default on the payments if you provide multiple payment options for convenience. You can provide choices like UPI, QR, NEFT, IMPS, e-wallet, and credit/debit cards.",
            icon: "💳",
        },
        {
        ...
        <section className="py-10 bg-gray-50 banifite-bg-content dark:bg-dark sm:py-16 lg:py-24">
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="text-center">
                    <Title subtitle='Benefits' title='3,583 Customers are using Celebration' />
                </div>
                    ...
                    <div className="grid grid-cols-1 gap-12 lg:gap-16 sm:grid-cols-2">
                        {benefits.map((benefit, index) => (
                            <div key={index} className="flex items-start">
                                <span className="flex-shrink-0 text-3xl text-fuchsia-600">{benefit.icon}</span>
                                <div className="ml-5">
                                    <h3 className="text-lg font-semibold  ">{benefit.title}</h3>
                                    <p className="mt-4 text-base dark:text-gray-400 text-gray-600">{benefit.description}</p>
                                </div>
                            </div>
                        ))}
                    </div>
