        ...
        <section className="bg-white dark:bg-gray-900">
            <div className="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-20">
                ...
                <div className="flex flex-col items-center text-center mb-12">
                    ...
                    <p className="mt-4 max-w-xl text-base text-gray-500 dark:text-gray-400 md:text-lg">
                        Our platform combines the power of ERP with the
                        simplicity of hosted e-commerce. Here’s what you get:
                    </p>
                </div>
                ...
                <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3">
                    {featuresData.map((feature, idx) => (
                        <div
                            key={idx}
                            className="flex flex-col gap-4 rounded-md border border-gray-300 dark:border-gray-700 p-6 md:p-8 bg-white dark:bg-gray-800 hover:shadow-lg transition-shadow"
                        >
