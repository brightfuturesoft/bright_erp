                ...
                <div className='relative'>
                    <div className="grid md:grid-cols-3 w-full gap-2 mt-3">
                        <div className="space-y-1">
                            ...
                            <DatePicker onChange={onChange} className='h-[40px] w-full' />
                        </div>
                        <div className="space-y-1 md:col-span-2">
                            <label htmlFor="description" className=' ml-1 text-xs'>Description</label>
                            <Input name='description' placeholder='Entry Description' className='dark:border-gray-700 !shadow-none dark:text-gray-300 w-full' />
                        </div>
                    </div>
                    <br />
