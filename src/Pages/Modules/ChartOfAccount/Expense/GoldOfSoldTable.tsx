...
const GoldOfSoldTable: React.FC = ({ data }) => {
    ...
    // Assuming filterData is your filtered and paginated data
    const paginatedData = data?.costTable?.filter(itm => itm.category === "Cost").slice((currentPage - 1) * pageSize, currentPage * pageSize);
            ...
            <div className="">
                <div className="py-2">
                    <div className="flex justify-between items-center mb-6">
                        <h2 className="text-2xl font-semibold dark:text-light capitalize">Expense</h2>
                ...
                <div className="flex justify-end mt-4">
                    <Pagination
                        current={currentPage}
                        pageSize={pageSize}
                        total={data?.costTable?.filter(itm => itm.category === "Cost").length}
