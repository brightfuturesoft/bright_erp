...
const BuisnessOwnerTable: React.FC = ({ data }) => {
    ...
    const discountData =
        data?.data?.filter(itm => itm.category === 'buisness_quantity') || [];
    const paginatedData = discountData.slice(
        ...
        <div>
            <div className="">
                ...
                <Modal
                    ...
                    title={`Add Owner's Equity Account > ${data?.label}`}
                    open={isAddModalOpen}
                    onOk={handleAddOk}
                ...
                <Modal
                    footer={false}
                    className="!shadow-none"
                    title={`Update Owner's Equity Account > ${data?.label}`}
