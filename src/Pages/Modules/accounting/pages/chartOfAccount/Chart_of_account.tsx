    ...
    return (
        <div className="bg-light dark:bg-dark text-dark dark:text-light">
            <div className="flex justify-between items-center mt-3">
                ...
                {/* <input placeholder='Search...' type="text" className="border-gray-400 dark:border-gray-600 bg-transparent px-2 py-1 border rounded w-[230px] text-black text-sm dark:text-gray-400" /> */}
            </div>
