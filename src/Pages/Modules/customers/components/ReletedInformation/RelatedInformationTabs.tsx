...
import Deliveries from './order/deliveris/Deliveries';
import CustomerDetailOrders from '@/Pages/Modules/E_Commerce/coustomers/components/ReletedInformation/order/CustomerDetailOrder';
