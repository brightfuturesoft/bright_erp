...
const EditCategory_Modal: React.FC<{ visible: boolean, onCancel: () => void, onOk: (values: any) => void, category: any }> = ({ visible, onCancel, onOk, category }) => {
...
export default EditCategory_Modal;
