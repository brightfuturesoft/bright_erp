// src/Pages/Modules/Cart/components/DataTable.tsx
import { Table, Image, Tooltip, theme, message, Space, Dropdown } from 'antd';
import React from 'react';
import { useCartData } from './data_get_api';
import { EllipsisVertical } from 'lucide-react';

const DataTable: React.FC<{ data: any[] }> = ({ data }) => {
    // You can use a hook like `useAntdTheme` or a context to get the current theme algorithm
    const { updateCartItem, deleteCartItem, refetch } = useCartData();
