  ...
  const columns: TableColumnsType<DataType> = [
    {
      ...
      dataIndex: "photo",
      render: (photo) => (
        <img src={photo} alt="Photo" style={{ width: 50, height: 50 }} />
      ),
    },
    {
      title: "Name",
  ...
  return (
    <div>
      ...
      >
        <div>
          <Button
            className="!bg-[#3946d1] !border-none !rounded !text-white"
            size="large"
            type="primary"
            onClick={start}
        ...
        <div className="flex items-center gap-2">
          <Input
            className="border-gray-700 bg-transparent px-3 py-2 border rounded text-white placeholder:text-gray-600"
          ...
          <Link
            className="!bg-[#3946d1] px-4 py-2.5 !border-none !rounded !text-white text-nowrap text-sm"
            to={`create-customer`}
          >
            +Add Customer
          </Link>
      ...
      >
        {editingRecord && (
          ...
          >
            ...
            <div className="relative edit-img">
              <Form.Item
                name="photo"
                label="Photo URL"
                rules={[
                  { required: true, message: "Please input the photo URL!" },
                ]}
              >
                <Upload
                  name="photo"
