...
const BuisnessOwnerTable: React.FC = ({ data }) => {
    ...
    const discountData = data?.data?.filter(itm => itm.category === "buisness_quantity") || [];
    ...
    return (
        <div>
            <div className="">
                ...
                <Modal footer={false} className='!shadow-none' title={`Add Owner's Equity Account > ${data?.label}`} open={isAddModalOpen} onOk={handleAddOk} onCancel={handleAddCancel}>
                ...
                {/* Edit Item Modal */}
                <Modal footer={false} className='!shadow-none' title={`Update Owner's Equity Account > ${data?.label}`} open={isEditModalOpen} onOk={handleEditOk} onCancel={handleEditCancel}>
...
export default BuisnessOwnerTable;
