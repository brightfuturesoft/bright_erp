...
const PaymentProcessingFeeTable: React.FC = ({ data }) => {
    ...
    const discountData = data?.data?.filter(itm => itm.category === "Payment Processing Fee") || [];
...
export default PaymentProcessingFeeTable;
