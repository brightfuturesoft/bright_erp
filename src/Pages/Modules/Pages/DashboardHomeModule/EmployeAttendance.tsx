...
const EmployeeAttendance: React.FC = () => {
    ...
    const calculateTotals = (empName: string) => {
        const filteredEmployeesForTotal = selectedName ? employee.filter(emp => emp.name === empName) : employee;

        return chartData.reduce((totals, item) => {
            filteredEmployeesForTotal.forEach(emp => {
                totals.Attendance += emp.attendance[chartData.indexOf(item)];
    ...
    return (
        <div>
            <div className="md:flex text-dark dark:text-gray-300 items-center justify-between">
                <DashboardTitle title={"Employee Attendance"} />

                <div className="flex items-center pb-8 mt-2 gap-4">
            ...
            <div className='dark:bg-light-dark dark:text-white text-dark dark:border-gray-700 border-gray-200 dark:shadow-none shadow-xl shadow-[#8080800e] mb-12 border rounded-xl md:p-4 p-2'>
                <div>
                ...
                <ResponsiveContainer width="100%" height={400}>
                    ...
                    >
                        ...
                        <Line type="monotone" dataKey="Absence" stroke="#82ca9d" />
                        <Line type="monotone" dataKey="Weekend" stroke="#ffc658" />
                    </LineChart>
                </ResponsiveContainer>
                {selectedName !== '' &&
                ...
                {selectedName === '' &&
                    <div className="summary">
                        <h3>Total Summary</h3>
                        <p>Total Attendance: {calculateTotals('').Attendance}</p>
