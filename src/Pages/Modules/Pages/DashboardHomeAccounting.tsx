...
const DashboardHomeAccounting: React.FC = () => {
        ...
        <section className='py-3'>
            <header className='flex items-center justify-between '>
                ...
                <div className="md:hidden block">
                    <Button className='flex items-center gap-1' type='primary' onClick={() => setIsModalOpen(true)}>
...
export default DashboardHomeAccounting;
