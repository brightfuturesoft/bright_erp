...
const PaymentLayout: React.FC = () => {
    ...
    return (
        <div className="bg-light dark:bg-dark pb-20 min-h-screen overflow-y-auto">
            <HomeNav />
            <div className="mx-auto mt-20 px-4 sm:px-6 lg:px-8 pt-6 max-w-7xl">
                <h1 className="pb-8 font-bold text-2xl text-center md:text-4xl dark:text-white">
                    Checkout
                </h1>
                <div className="flex md:flex-row flex-col justify-center items-center">
                    ...
                    <button
                        onClick={() => onToggle({ target: { value: 'Visa' } })}
                        type="button"
